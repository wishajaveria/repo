...
let university = {
    ...
    totalStudentsInCommerceDeparment: [{
        ...
        AccountingFunctionInBanking: {
            ...
            maleStudents: 6,
            professorBioData: {
                name: "sir shameer shah",
                qualification: "qualified in banking",
                isStrick: "no",
                age: 45,
        ...
        FinancialAppraisal: {
            ...
            professorBioData: {
                name: "sir waheed zaki",
                qualification:"financial appraisal",
                isStrick: "yes",
                age: 44,

            }
        },
        principlesOfCommerce: {
            totalStudents: 23,
            attendence: "90% attendence",
            progress: "good",
            femaleStudents: 13,
            ...
            professorBioData: {
                name: "junaid akbar",
                qualification: "qualified in principles of commerce",
                isStrick: "yes",
                age: 44,
    ...
    libraryOfKarachiUniversity:{
        totalLibraryInKarachiUniversity:1,
        isLibraryIsBig:"yes",
        totalFloorOfLibrary:"six floors",
    ...
    canteen:{
        CanteensOfKarachiUniversity:{
            ...
            GiveTo:"if student obedient",
                ...
                GiveTo:"if is a helpful",
                GiveTo:"if he respect teachers",
            },

            masjidInKarachiUniversity:[
                "to offer namaz",

            ],
            girlsCommonRoomInKarachiUniversity:{
                usedFor:"namaz",
                usedFor:"waiting for next class",
